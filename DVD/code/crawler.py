...
consumer_key = 'u2LeBUXkSPV4ExPzS2QqOsLtR'
consumer_secret = '0rrAGCxC9rm08XYGFjx5ZS1ecs0cyWEkcOFTrFGaxfD3KZY27J'
access_token = '737739156110086144-gXPHCWRCJvGUHwVt1s8p8lBwT8CT0z8'
access_secret = 'zAsYfRdPqej4TJpZFjnRDMVgjbw49t1jR0HCIVM4Pe3em'
...
def collect_tweets(city, geocode, query="*"):
    ...
    :return: nothing.
    """
    cursor = (tweepy.Cursor(api.search, since="2016-05-31", until="2016-06-01", q=query, geocode=geocode).items())
    print('start')
